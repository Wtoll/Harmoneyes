use defmt::unwrap;
use embassy_nrf::{peripherals::{P0_16, PWM0}, pwm::{Config, Prescaler, SequenceConfig, SequenceLoad, SequencePwm, SingleSequenceMode, SingleSequencer}};
...
pub async fn task(
    ...
    let mut pwm = unwrap!(SequencePwm::new_1ch(p_pwm, p_pin, config));
